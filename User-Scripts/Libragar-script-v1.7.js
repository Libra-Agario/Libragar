// ==UserScript==
// @name         🤵 Libragar Mode V1.7 💡 Libra - Agario YT | www.Libragar.pw | 100 Free Minions/Bots 💡
...
// @Update V1.7 ->>
// NEW 3 GAME MODES ADDED. - these new game modes are hosted in server Europe. if it's lag, feedback please.
// web.libragar.pw published. now you can play without entering agario. " at the demo stage. "
...
//    } // 2x Split
//    if (event.keyCode == ?) { // ---------------------------------------> // Key Number ? // 2x Split // Press Key " ? " //
//        Librakeys3();
