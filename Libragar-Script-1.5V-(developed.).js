...
//    if (l.which == 108) {
//        window.xhttp = core.disableIntegrityChecks(true); core.connect("wss://test-libra.codeanyapp.com"); // Libra Agar.io Test Server // Button Function L //
//
//    }
// });
...
document.getElementById('id1234').addEventListener('click', function(event) {
    window.xhttp = core.disableIntegrityChecks(true); core.connect("wss://test-libra.codeanyapp.com");
});
